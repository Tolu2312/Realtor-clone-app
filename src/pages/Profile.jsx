  ...
  return (
    <>
      <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
        ...
        <div className="w-full md:w-[50%] mx-6 px-3">
          <form>
            {/* Name Input */}
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6"> 
              ...
              <p onClick={onLogout} className="text-blue-600 hover:text-blue-800 transition duration-300 ease-in-out cursor-pointer">Sign out</p>
            </div>
          </form>
